...
% Comments with \fxnote and corrections with \fxfatal. With 'final' instead of 'draft' every \fxfatal will throw an error in the final report.
\usepackage[footnote,english,final,silent,nomargin]{fixme}
