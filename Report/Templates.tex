DISCLAIMER: Denne skabelon er fra en anden type LaTeX-dokument, og det er derfor ikke sikkert at alt virker efter hensigten.
...
\fig{STOERRELSE}{FIL}{FIGURTEKST.}{fig:LABEL}
...
\begin{table}[htbp] % alternativt [H]
	\centering 
...
\box{Heading goes here}{LabelHere}{
    Content here.
    \tcblower
...
\pageref{box:LabelHere}. Uniform active reference: \factboxref{LabelHere}.
