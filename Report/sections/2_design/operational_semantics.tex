...
The definition for a set of record environments \textbf{Env_R} is given by:
...
Similarly, to ensure that every procedure is able to obtain the records, procedures and variables when a procedure is declared we give the definition as:
