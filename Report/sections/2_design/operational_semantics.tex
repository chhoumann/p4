...
The definition of the transition system for each expression type in \dazel{} is shown in \figref{fig:TS_Aexp}, \figref{fig:TS_Bexp}, \figref{fig:TS_Decv} and \figref{fig:TS_Decp} 
\begin{figure}[htbp]
	\begin{gather*} 
...
\begin{figure}[htbp]
	\begin{gather*} 
		...
		\textit{Configurations: } \Gamma_\text{Dv} = \mathbb{(Dec_v * Env_v * sto)} \cup \mathbb{Env_v * sto} \\ 
		\textit{Terminal configurations: } T_\text{Dec}_v = \mathbb{Env_v * sto}
	\end{gather*} 
	\label{fig:TS_Decv}
	\caption{Transition system for arithmetic expressions}
\end{figure}
...
\begin{figure}[htbp]
	\begin{gather*} 
		...
		\textit{Configurations: } \Gamma_\text{Dp} = \mathbb{(Dec_p * Env_p)} \cup \mathbb{Env_p} \\ 
		\textit{Terminal configurations: } T_\text{Dp} = \mathbb{Env_p}
	\end{gather*} 
	\label{fig:TS_Decp}
	\caption{Transition system for arithmetic expressions}
\end{figure}
