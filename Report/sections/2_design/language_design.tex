...
This chapter details the design of \dazel. In the specification of \dazel{} in \figref{dazel_specification}, it was decided that the language should promote practical learning while providing visual feedback to the written code. On the account of this, the \dazel{} will be designed as an interpreted language used to build video games.
