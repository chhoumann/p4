...
\begin{table}[h!]
    ...
    \hline
    Player                       & \begin{tabular}[c]{@{}l@{}}Is globally accessible and always \\points to the player. This allows \\the programmer to~create \\interactions involving~the player \\as well providing access to \\their properties such as~health \\and move speed.\end{tabular}  \\ 
    \hline
    ...
    \hline
    Screen                       & \begin{tabular}[c]{@{}l@{}}Denotes a screen block, which is a \\container for other blocks such as \\'Map', 'OnScreenEntered', 'Entities', \\and 'Exits'.\end{tabular}                                                                                          \\ 
    \hline
    Entity                       & \begin{tabular}[c]{@{}l@{}}Denotes an entity block used to define the \\behavior of an entity.\end{tabular}                                                                                                                                                     \\ 
    \hline
    MovePattern                  & \begin{tabular}[c]{@{}l@{}}Denotes a move pattern block which \\can be used to apply movement to\\entities.\end{tabular}                                                                                                                                        \\ 
    \hline
    ...
    \end{tabular}
    \caption{Table containing reserved keywords in \dazel}
