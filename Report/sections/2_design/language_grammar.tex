...
If a non-terminal has multiple reductions these can either be represented as multiple rules as seen in \figref{BNF_Example} or as a single rule where each option for the reduction is separated by a '|' symbol.
