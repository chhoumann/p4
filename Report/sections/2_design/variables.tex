...
This is illustrated in \snipref{lst:SampleScreen1} on line 47. In this example, the exit property with the identifier \texttt{Exit1} of \texttt{SampleScreen2.Exits} is accessed.
