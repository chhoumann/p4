\section{Studies on intuitive language design} \label{sec:scientific_research} \fxfatal{title..}
...
be more explicit about how scoping rules apply in their language\cite{bosse_why_2017}.


\fxfatal{Fix this so that it is a proper section reference.}
