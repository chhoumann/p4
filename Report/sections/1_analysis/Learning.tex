...
\section{Learning} \label{chap:learning}
...
\section{Video games and computer interest} \label{chap:games_and_interest}
...
\section{How to get more people starting with programming}\label{chap:analysis}
