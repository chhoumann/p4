...
\vspace*{\fill}
  ...
  {\color{white}\fboxsep0pt\colorbox{aaublue}{\begin{tabular}{@{}p{\textwidth}@{}}
    ...
    \begin{center}
      \Large{
        A Programming Language for Generating Games% insert your subtitle here
      }
    \end{center}
    %% \vspace{0.2cm}
   \begin{center}
    {\large
      Andreas Kamp, Christian Houmann, Ivik Hostrup, John Nguyen, Patrick Østergaard, Rasmus Pyke% insert names separated by comma
    }\\
    \vspace{0.4cm}
    {\large
      \textit{Software, SW420F21, 2021}% insert name of study, group number, year-month
    }
  \end{center}
   \vspace{0.2cm}
