...
As can be seen on line \ref{line:ScreenModelsIEnumerable}, the class stores a reference to the \texttt{ScreenModels} from the from the code generation phase in the compiler and uses the models to build the game world. 
