...
\fig{0.8}{Dazel_ScreenExit}{The result of the code in \snipref{lst:DazelScreenExit}. Two screens are generated and a \texttt{ScreenExit} is created on the left of \texttt{SampleScreen1} which connects it to \texttt{SampleScreen2}.}
