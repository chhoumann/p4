...
\begin{lstlisting}[language=CSharp, caption={Two simple visit methods for integers and floats in the \textbf{ExpressionTypeChecker} class.}, label={lst:ExpressionTypeChecker},escapechar=|]
